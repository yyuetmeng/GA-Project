...
I am moving to California. So, I am looking at the possible schools that I can enrol my son so that he can eventually go to college of his choice.


### Datasets

#### Below are the datasets that I am using for this analysis
...
My deliverable are as follows. 
- A Jupyter notebook that describes your data with visualizations & statistical analysis.
- A README markdown file the provides an introduction to and overview of your project.
- Presentation slideshow rendered as a .pdf file.

---

### Technical Report Starter Code

- Project 1_Submission.ipynb-  Jupyter notebook that has the data exploration and analysis.
